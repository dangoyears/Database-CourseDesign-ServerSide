...
(
   ...
   constraint PK_CLASS primary key ("ClassID", "Grade", "Class")
);
...
alter table "Student"
   add constraint FK_STUDENT_STUDENTBE_CLASS foreign key ("ClassID", "Grade", "Class")
      references "Class" ("ClassID", "Grade", "Class");
